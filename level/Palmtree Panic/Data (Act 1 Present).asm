...
; -------------------------------------------------------------------------
	...
	if REGION=USA
	incbin	"Level/Palmtree Panic/Data/Padding/1 (U).bin"
	else
	incbin	"Level/Palmtree Panic/Data/Padding/1 (JE).bin"
	endif
...
LevelLayouts:
	dc.w .FG-LevelLayouts
	dc.w .BG-LevelLayouts
	dc.w .Null-LevelLayouts
	dc.w .Null-LevelLayouts
	dc.w .Null-LevelLayouts
	dc.w .Null-LevelLayouts
	dc.w .Null-LevelLayouts
...
; -------------------------------------------------------------------------
	...
	incbin	"Level/Palmtree Panic/Data/Padding/2.bin"
