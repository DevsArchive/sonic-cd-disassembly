...
Pal_EasterEgg:
	if EASTEREGG=0
		incbin	"sndtest/easteregg/data/funisinfinite.pal"
	elseif EASTEREGG=1
		incbin	"sndtest/easteregg/data/mcsonic.pal"
	elseif EASTEREGG=2
		incbin	"sndtest/easteregg/data/tails.pal"
	elseif EASTEREGG=3
		incbin	"sndtest/easteregg/data/batman.pal"
	elseif EASTEREGG=4
		incbin	"sndtest/easteregg/data/cutesonic.pal"
	endif
Pal_EasterEgg_End:
	even
...
Art_EasterEgg:
	if EASTEREGG=0
		incbin	"sndtest/easteregg/data/funisinfinite.art.nem"
	elseif EASTEREGG=1
		incbin	"sndtest/easteregg/data/mcsonic.art.nem"
	elseif EASTEREGG=2
		incbin	"sndtest/easteregg/data/tails.art.nem"
	elseif EASTEREGG=3
		incbin	"sndtest/easteregg/data/batman.art.nem"
	elseif EASTEREGG=4
		incbin	"sndtest/easteregg/data/cutesonic.art.nem"
	endif
	even

Map_EasterEgg:
	if EASTEREGG=0
		incbin	"sndtest/easteregg/data/funisinfinite.map"
	elseif EASTEREGG=1
		incbin	"sndtest/easteregg/data/mcsonic.map"
	elseif EASTEREGG=2
		incbin	"sndtest/easteregg/data/tails.map"
	elseif EASTEREGG=3
		incbin	"sndtest/easteregg/data/batman.map"
	elseif EASTEREGG=4
		incbin	"sndtest/easteregg/data/cutesonic.map"
	endif
	even

; -------------------------------------------------------------------------

	include	"sndtest/functions.asm"
