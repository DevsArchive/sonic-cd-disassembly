...
.SPCmds:
	...
	dc.w	SPCmd_ReadBuRAM-.SPCmds		; $87 | Read Backup RAM
...
.ReadData:
	...
	lea	BuRAMReadParams(pc),a0		; Read Backup RAM data
	lea	WORDRAM_2M,a1
	move.w	#BRMREAD,d0
	jsr	_BURAM.w
...
.WriteData:
	...
	lea	BuRAMWriteParams(pc),a0		; Write Backup RAM data
	lea	WORDRAM_2M,a1
	move.w	#BRMWRITE,d0
	moveq	#0,d1
	jsr	_BURAM.w
