...
%ASM68K% "Selection Menu\Sound Test.asm", "_Built\Files\SOSEL_.MMD", , "Selection Menu\Sound Test.lst"
%ASM68K% "Selection Menu\Stage Select.asm", "_Built\Files\STSEL_.MMD", , "Selection Menu\Stage Select.lst"

%ASM68K% /e EASTEREGG=0 "Selection Menu\Easter Egg\Main.asm", "_Built\Files\NISI.MMD", , "Selection Menu\Easter Egg\Main (Fun Is Infinite).lst"
%ASM68K% /e EASTEREGG=1 "Selection Menu\Easter Egg\Main.asm", "_Built\Files\DUMMY0.MMD", , "Selection Menu\Easter Egg\Main (M.C. Sonic).lst"
%ASM68K% /e EASTEREGG=2 "Selection Menu\Easter Egg\Main.asm", "_Built\Files\DUMMY1.MMD", , "Selection Menu\Easter Egg\Main (Tails).lst"
%ASM68K% /e EASTEREGG=3 "Selection Menu\Easter Egg\Main.asm", "_Built\Files\DUMMY2.MMD", , "Selection Menu\Easter Egg\Main (Batman).lst"
%ASM68K% /e EASTEREGG=4 "Selection Menu\Easter Egg\Main.asm", "_Built\Files\DUMMY3.MMD", , "Selection Menu\Easter Egg\Main (Cute Sonic).lst"
